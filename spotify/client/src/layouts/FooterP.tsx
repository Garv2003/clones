...
const FooterP = () => {
  return (
    <div className="bg-black">
      <footer className="text-subtext max-w-[1050px] mx-auto">
        <div className="p-[16px] flex-col">
          <div className="p-[16px] flex justify-between h-80">
            <div className="flex gap-20 flex-wrap">
              ...
              <ul className="flex flex-col gap-3">
                <li className="font-medium">Communities</li>
                <li className="cursor-pointer  text-white hover:text-green-400">
                  For Artists
                </li>
                <li className="cursor-pointer  text-white hover:text-green-400">
              ...
              <ul className="flex flex-col gap-3">
                <li className="cursor-pointer font-medium">Useful links</li>
                <li className="cursor-pointer  text-white hover:text-green-400">
                  Support
                </li>
                <li className="cursor-pointer  text-white hover:text-green-400">
            ...
            <div className="flex gap-2">
              <div className="bg-iconbtn w-12 h-12 rounded-full items-center justify-center inline-flex text-white group">
                {" "}
                <FaInstagram className="text-2xl  group-hover:text-green-400" />
              </div>
              <div className="bg-iconbtn w-12 h-12 rounded-full items-center justify-center inline-flex text-white group">
                {" "}
                <FaTwitter className="text-2xl  group-hover:text-green-400" />
              </div>
              <div className="bg-iconbtn w-12 h-12 rounded-full items-center justify-center inline-flex text-white group">
                {" "}
                <FaFacebook className="text-2xl group-hover:text-green-400" />
              </div>
            </div>
          </div>
          <div className="pt-[16px] w-full flex justify-between h-[150px] items-center text-xs">
            <ul className="flex gap-4 flex-wrap">
              <li className="cursor-pointer hover:text-green-400">Legal</li>
              ...
              <li className="cursor-pointer hover:text-green-400">Cookies</li>
              <li className="cursor-pointer hover:text-green-400">About Ads</li>
              <li className="cursor-pointer hover:text-green-400">
                Accessibility
              </li>
            </ul>
            <div className="flex flex-col gap-5">
              ...
              <div className="cursor-pointer">© 2023 Spotify AB</div>
            </div>
          </div>
        </div>
      </footer>
